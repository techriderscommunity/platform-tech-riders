...
Define the non-negotiable guidance for telemetry decisions in backend systems.
...
- Keep telemetry decisions explicit, traceable, and aligned with system boundaries.
...
- Applying telemetry advice without checking constraints of the current architecture and workload.
