...
Define the non-negotiable guidance for tracing decisions in backend systems.
...
- Keep tracing decisions explicit, traceable, and aligned with system boundaries.
...
- Applying tracing advice without checking constraints of the current architecture and workload.
