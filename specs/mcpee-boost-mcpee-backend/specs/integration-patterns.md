# Integration Patterns Spec

## Purpose

Define the non-negotiable guidance for integration patterns decisions in backend systems.
...
- Keep integration patterns decisions explicit, traceable, and aligned with system boundaries.
...
- Applying integration patterns advice without checking constraints of the current architecture and workload.
