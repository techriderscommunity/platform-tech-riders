...
Define the non-negotiable guidance for CQRS decisions in backend systems.
...
- Keep CQRS decisions explicit, traceable, and aligned with system boundaries.
...
- Applying CQRS advice without checking constraints of the current architecture and workload.
