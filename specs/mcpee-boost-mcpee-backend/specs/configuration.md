...
Define the non-negotiable guidance for configuration decisions in backend systems.
...
- Keep configuration decisions explicit, traceable, and aligned with system boundaries.
...
- Applying configuration advice without checking constraints of the current architecture and workload.
