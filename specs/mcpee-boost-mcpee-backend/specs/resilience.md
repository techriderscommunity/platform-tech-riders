...
Define the non-negotiable guidance for resilience decisions in backend systems.
...
- Keep resilience decisions explicit, traceable, and aligned with system boundaries.
...
- Applying resilience advice without checking constraints of the current architecture and workload.
