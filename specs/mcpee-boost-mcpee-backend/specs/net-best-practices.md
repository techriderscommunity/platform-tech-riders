# .NET Best Practices Spec

## Purpose

Define the non-negotiable guidance for .NET best practices decisions in backend systems.
...
- Keep .NET best practices decisions explicit, traceable, and aligned with system boundaries.
...
- Applying .NET best practices advice without checking constraints of the current architecture and workload.
