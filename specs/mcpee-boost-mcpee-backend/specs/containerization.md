...
Define the non-negotiable guidance for containerization decisions in backend systems.
...
- Keep containerization decisions explicit, traceable, and aligned with system boundaries.
...
- Applying containerization advice without checking constraints of the current architecture and workload.
