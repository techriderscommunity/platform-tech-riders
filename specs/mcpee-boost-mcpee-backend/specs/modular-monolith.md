# Modular Monolith Spec

## Purpose

Define the non-negotiable guidance for modular monolith decisions in backend systems.
...
- Keep modular monolith decisions explicit, traceable, and aligned with system boundaries.
...
- Applying modular monolith advice without checking constraints of the current architecture and workload.
