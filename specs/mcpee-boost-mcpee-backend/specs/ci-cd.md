...
Define the non-negotiable guidance for CI CD decisions in backend systems.
...
- Keep CI CD decisions explicit, traceable, and aligned with system boundaries.
...
- Applying CI CD advice without checking constraints of the current architecture and workload.
