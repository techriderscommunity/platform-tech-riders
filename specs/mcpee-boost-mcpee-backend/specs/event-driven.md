...
Define the non-negotiable guidance for event driven decisions in backend systems.
...
- Keep event driven decisions explicit, traceable, and aligned with system boundaries.
...
- Applying event driven advice without checking constraints of the current architecture and workload.
