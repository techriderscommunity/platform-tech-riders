...
Define the non-negotiable guidance for database first decisions in backend systems.
...
- Keep database first decisions explicit, traceable, and aligned with system boundaries.
...
- Applying database first advice without checking constraints of the current architecture and workload.
