...
Define the non-negotiable guidance for data protection decisions in backend systems.
...
- Keep data protection decisions explicit, traceable, and aligned with system boundaries.
...
- Applying data protection advice without checking constraints of the current architecture and workload.
