...
Define the non-negotiable guidance for dependency injection decisions in backend systems.
...
- Keep dependency injection decisions explicit, traceable, and aligned with system boundaries.
...
- Applying dependency injection advice without checking constraints of the current architecture and workload.
