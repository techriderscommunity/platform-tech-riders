...
Define the non-negotiable guidance for caching decisions in backend systems.
...
- Keep caching decisions explicit, traceable, and aligned with system boundaries.
...
- Applying caching advice without checking constraints of the current architecture and workload.
