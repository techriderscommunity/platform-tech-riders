# Azure Backend Patterns Spec

## Purpose

Define the non-negotiable guidance for azure backend patterns decisions in backend systems.
...
- Keep azure backend patterns decisions explicit, traceable, and aligned with system boundaries.
...
- Applying azure backend patterns advice without checking constraints of the current architecture and workload.
