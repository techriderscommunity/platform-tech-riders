...
{
    /// <inheritdoc />
    public partial class AddIdentityCoreModel : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PersonStudies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PersonStudies_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "UserOrientationScopes",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Scope = table.Column<int>(type: "int", nullable: false),
                    OtherDetail = table.Column<string>(type: "nvarchar(160)", maxLength: 160, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserOrientationScopes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserOrientationScopes_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserProfileHistories_Profiles_ProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserCapabilities_UserId_CapabilityId",
                table: "UserCapabilities",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserOrientationScopes_UserId_Scope",
                table: "UserOrientationScopes",
                columns: new[] { "UserId", "Scope" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserProfileHistories_ProfileId",
