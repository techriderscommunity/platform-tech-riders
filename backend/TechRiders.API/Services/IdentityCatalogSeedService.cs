...
/// <summary>
/// Siembra el catálogo fijo de Perfiles y Capacidades (Requisitos Arquitectura §3.3/§3.5).
...
public static class IdentityCatalogSeedService
{
    ...
    // Member es automático (sin solicitud); estos 5 requieren aprobación de Admin/Staff.
    ...
    public static async Task EnsureDefaultsAsync(TechRidersDbContext dbContext, ILogger logger, CancellationToken cancellationToken = default)
    {
        ...
        logger.LogInformation("Catálogo de perfiles y capacidades verificado ({Profiles} perfiles, {Capabilities} capacidades).", ProfileNames.Length, CapabilityNames.Length);
    }
