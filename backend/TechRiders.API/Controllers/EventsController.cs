...
public class EventsController : BaseApiController
{
    ...
    public async Task<IActionResult> Publish(Guid id, CancellationToken cancellationToken)
    {
        try
        {
            await _eventSessionOpsService.SetEventStatusAsync(id, EventSessionStatusNames.Published, cancellationToken);
            return Ok();
        }
        catch (InvalidOperationException ex)
        {
    ...
    public async Task<IActionResult> Cancel(Guid id, CancellationToken cancellationToken)
    {
        try
        {
            await _eventSessionOpsService.SetEventStatusAsync(id, EventSessionStatusNames.Cancelled, cancellationToken);
            return Ok();
        }
        catch (InvalidOperationException ex)
        {
    ...
    {
        var registrations = await _eventSessionOpsService.GetEventRegistrationsAsync(id, cancellationToken);
    ...
    public async Task<IActionResult> UpdateRegistration(Guid registrationId, [FromBody] UpdateRegistrationStatusRequest request, CancellationToken cancellationToken)
    {
        try
        {
            await _eventSessionOpsService.UpdateEventRegistrationStatusAsync(registrationId, request.Status, cancellationToken);
            return Ok();
        }
