...
Provide an evidence-based migration analysis workflow that turns repository signals into prioritized, actionable guidance.

## When To Use

- Use this skill when a request requires migration analysis guidance with concrete evidence from the repository.
...
1. Identify the scope of the migration analysis request and the affected components.
