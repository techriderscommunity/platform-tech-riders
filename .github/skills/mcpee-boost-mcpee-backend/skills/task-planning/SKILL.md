...
Provide an evidence-based task planning workflow that turns repository signals into prioritized, actionable guidance.

## When To Use

- Use this skill when a request requires task planning guidance with concrete evidence from the repository.
...
1. Identify the scope of the task planning request and the affected components.
