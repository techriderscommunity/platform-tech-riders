...
Provide an evidence-based release review workflow that turns repository signals into prioritized, actionable guidance.

## When To Use

- Use this skill when a request requires release review guidance with concrete evidence from the repository.
...
1. Identify the scope of the release review request and the affected components.
