# Database First Review Skill

## Goal

Provide an evidence-based database first review workflow that turns repository signals into prioritized, actionable guidance.

## When To Use

- Use this skill when a request requires database first review guidance with concrete evidence from the repository.
...
1. Identify the scope of the database first review request and the affected components.
