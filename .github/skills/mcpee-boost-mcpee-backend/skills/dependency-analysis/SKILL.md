...
Provide an evidence-based dependency analysis workflow that turns repository signals into prioritized, actionable guidance.

## When To Use

- Use this skill when a request requires dependency analysis guidance with concrete evidence from the repository.
...
1. Identify the scope of the dependency analysis request and the affected components.
