...
Provide an evidence-based token budgeting workflow that turns repository signals into prioritized, actionable guidance.

## When To Use

- Use this skill when a request requires token budgeting guidance with concrete evidence from the repository.
...
1. Identify the scope of the token budgeting request and the affected components.
